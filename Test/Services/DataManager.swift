...
extension Question {
    ...
    static func getQuestions() -> [Question] {
        return [
            Question(title: "Чем отличаются операторы break и continue?", type: .single, level: .easy, answers: [
            ...
            Question(title: "Где правильно создана переменная?", type: .single, level: .easy, answers: [
            ...
            Question(title: "Где правильно создан массив со строками?", type: .single, level: .easy, answers: [
            ...
            Question(title: "Какая библиотека нужна для создания пользовательского интерфейса?", type: .single, level: .easy, answers: [
            ...
            Question(title: "Как расшифровывается MVC", type: .single, level: .easy, answers: [
            ...
            Question(title: "В приведённом списке выберите логические операторы.", type: .multiple, level: .easy, answers: [
            ...
            Question(title: "Отметьте строки программного кода, содержащие ошибки.", type: .multiple, level: .easy, answers: [
...
//            Средний уровень
            Question(title: "Тип, который определяет набросок методов, свойств и т.д.:", type: .single, level: .middle, answers: [
            ...
            Question(title: "Можно ли добавить stored property к типу, используя extencion", type: .single, level: .middle, answers: [
            ...
            Question(title: "Неупорядоченная коллекция, хранящая в себе значения с уникальным ключом – это", type: .single, level: .middle, answers: [
            ...
            Question(title: "Что произойдёт при обращении к массиву из пяти элементов по индексу 5?", type: .single, level: .middle, answers: [
            ...
            Question(title: "Как Apple рекомендует открывать UITableViewController?", type: .single, level: .middle, answers: [
            ...
            Question(title: "Выберете два правильных вариантов создание массива", type: .multiple, level: .middle, answers: [
            ...
            Question(title: "Выберете два правильных вариантов создание словаря", type: .multiple, level: .middle, answers: [
...
//            Сложный уровень
            Question(title: "Замыкания — это какой тип-значние?", type: .single, level: .hard, answers: [
                            Answer(title: "Все ответы верны", correct: false),
            ...
            Question(title: "Какие типы коллекций доступны в Swift?", type: .single, level: .hard, answers: [
            ...
            Question(title: "Что означает mutatingключевое слово? ", type: .single, level: .hard, answers: [
            ...
            Question(title: "Optional это - ", type: .single, level: .hard, answers: [
            ...
            Question(title: "Что такое Enum?", type: .single, level: .hard, answers: [
            ...
            Question(title: "Какие языки поддерживает Xcode", type: .multiple, level: .hard, answers: [
            ...
            Question(title: "В приведённом списке выберите логические операторы.", type: .multiple, level: .hard, answers: [
